...
const Hero = () => {
    ...
    return (
        <section className="flex flex-col lg:flex-row items-center justify-between px-4 lg:px-12 pt-10 text-white mt-7 lg:mt-[110px]" style={{ backgroundColor: '#0890F1' }}>
            <div className="flex-1 lg:pr-12  order-2 lg:order-1 pb-4 ">
               ...
               <span className='text-xl font-normal text-center lg:text-2xl'> Clean. Anywhere. Anytime. </span>
                ...
                <div className='bg-opacity-80 flex rounded pr-2'>
                    ...
                    <div className="grid md:grid-cols-2 grid-cols-1 gap-3 mt-3  md:pl-4 md:pl-0 ">
